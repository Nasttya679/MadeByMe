...
namespace MadeByMe.Infrastructure.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Posts",
                columns: new[] { "Id", "CategoryId", "created_at", "Description", "Price", "Rating", "SellerId", "Status", "Title" },
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 1, 10, 12, 0, 0, 0, DateTimeKind.Unspecified), "Ручної роботи з натуральним каменем", 799.99m, 0.0m, "22222222-2222-2222-2222-222222222222", "active", "Срібна сережка" },
                    { 2, 2, new DateTime(2024, 1, 5, 12, 0, 0, 0, DateTimeKind.Unspecified), "Керамічна ваза з українським орнаментом", 1200.50m, 0.0m, "22222222-2222-2222-2222-222222222222", "active", "Декоративна ваза" },
                    { 3, 3, new DateTime(2023, 12, 30, 12, 0, 0, 0, DateTimeKind.Unspecified), "Олія на полотні, 40x60 см", 2500.00m, 0.0m, "22222222-2222-2222-2222-222222222222", "active", "Картина 'Сонячний день'" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "22222222-2222-2222-2222-222222222222" },
                    { 3, 3, "22222222-2222-2222-2222-222222222222" }
                });
